...
interface AdminControlsProps {
  ...
  isOpen?: boolean;
  onClose?: () => void;
  hideHeader?: boolean; // New prop to hide header when inside shared panel
}
...
export const AdminControls: React.FC<AdminControlsProps> = ({
  ...
  // Content without outer wrapper (for shared panel)
  const content = (
    <>
      {/* End Meeting Button */}
  ...
  // If hideHeader is true, return content without wrapper (for shared panel)
  if (hideHeader) {
    return (
      <div
        style={{
  ...
  // Default: return with full wrapper and header
  return (
    <div
      style={{
        width: "100%",
