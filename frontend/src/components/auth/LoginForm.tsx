...
type LoginMethod = 'google' | 'github';
        ...
        <div className="space-y-3">
          <div className="relative">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-3.5 border-2 border-gray-300 rounded-lg hover:bg-gray-50 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:border-gray-400"
            >
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="text-base font-medium text-gray-700">Continue with GitHub</span>
            </button>
